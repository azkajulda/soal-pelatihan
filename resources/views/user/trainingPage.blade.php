                ...
                <div class="col-md-4">
                    <div class="card card-chart">
                        ...
                        <div class="card-footer">
                            <div class="stats">
                                <i class="material-icons">access_time</i> created at : {{$trainings->created_at}}&nbsp;
                ...
                @csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group" style="margin-top: 25px;">
                            ...
                            <textarea class="form-control" id="Training Description" rows="3" name="training_description"></textarea>
                        </div>
