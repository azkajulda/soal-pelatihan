    ...
    <div class="materialContainer">
        <div class="box">
            <div class="title">LOGIN</div>
                ...
                <div class="input">
                    ...
                    <input type="number" id="name" class="form-control @error('email') is-invalid @enderror" name="email" required autocomplete="email" autofocus>
        ...
        <div class="overbox">
            ...
            <form method="POST" action="{{ route('register') }}">
                @csrf
                <div class="input">
                    <label for="regname">NIK</label>
                    <input id="regname" type="number" class="form-control @error('email') is-invalid @enderror" name="email" required autocomplete="email">
                    <span class="spin"></span>
                </div>
                @error('email')
                <span class="invalid-feedback" role="alert">
